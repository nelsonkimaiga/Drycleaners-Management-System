...
//Calling our method to populate the jtable
 private void updateJTable(){
             try{
             String sql ="Select `First_Name`, `Last_Name`, `Phone_Number`, `Residence`, `Date` FROM `customer_details` ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EXISTING CLIENTS");
...
dispose();// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      /*try{
          ...
          JasperDesign jpd=JRXmlLoader.load("Tenants.jrxml");
...
String REPORT="C:\\Users\\Kimaiga\\Documents\\NetBeansProjects\\Prestige Drycleaners\\src\\Customers.jrxml";
